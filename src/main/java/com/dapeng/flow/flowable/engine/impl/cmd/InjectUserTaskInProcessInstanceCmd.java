package com.dapeng.flow.flowable.engine.impl.cmd;
...
public class InjectUserTaskInProcessInstanceCmd extends AbstractDynamicInjectionCmd implements Command<Void> {
    ...
    protected String injectPosition;

    public InjectUserTaskInProcessInstanceCmd(String processInstanceId, DynamicUserTaskBuilder dynamicUserTaskBuilder, String injectPosition) {
